...
test_that("get_pop_counts works", {
  ...
  expect_identical(colnames(cd4p_tbl)[[4]], "CD4+")
  expect_identical(colnames(cd4n_tbl)[[4]], "CD4-")
  expect_identical(colnames(cd4_tbl)[4:5], c("CD4+", "CD4-"))
