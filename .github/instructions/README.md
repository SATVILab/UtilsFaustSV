...
|------|------------|---------|
| `r-package-code.instructions.md` | `R/*.R` | R code style, naming, documentation |
| `testthat-tests.instructions.md` | `tests/testthat/test-*.R` | Test patterns, assertions, cross-platform |
...
1. **Keep the same structure and format** - All files follow the template above
