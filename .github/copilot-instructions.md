...
17. When working with FAUST population definitions, use the tilde notation (e.g., "CD3~2~2~") for internal processing and convert to/from plus/minus notation (e.g., "CD3+") for user-facing interfaces.
